#############################################################################
# Makefile for building: EventToken-qt
# Generated by qmake (3.0) (Qt 5.3.1)
# Project:  EventToken-qt.pro
# Template: app
# Command: C:\Qt\5.3.1\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile EventToken-qt.pro
#############################################################################
...
Makefile: EventToken-qt.pro ../../Qt/5.3.1/mkspecs/win32-g++/qmake.conf ../../Qt/5.3.1/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile EventToken-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\walets\EventToken\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\walets\EventToken\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\walets\EventToken\eventtoken-qt_plugin_import.cpp

C:/walets/EventToken/src/leveldb/libleveldb.a: FORCE
