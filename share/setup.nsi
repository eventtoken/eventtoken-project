...
!define URL http://www.EventToken.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/EventToken.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\EventToken-qt.exe
...
OutFile EventToken-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/EventToken-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/EventTokend.exe
    ...
    #Delete /REBOOTOK $INSTDIR\EventToken.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\EventToken-qt.exe
