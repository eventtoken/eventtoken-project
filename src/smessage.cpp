// Copyright (c) 2014 The EventToken developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("EventToken-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("EventToken-smsg-pow"); // Make this thread recognisable
