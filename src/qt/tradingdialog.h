...
private slots:
    ...
    void on_BuyEVENT_clicked();
    void on_SellEVENTBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputEVENT_textChanged(const QString &arg1);
    ...
    QString BuyEVENT(QString OrderType, double Quantity, double Rate);
    QString SellEVENT(QString OrderType, double Quantity, double Rate);
