...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.EventToken
    BOOST_LIB_SUFFIX=-mt
...
# We need to exclude this for win32 cross compile with MinGW 4.2.x, as it will result in a non-working executable!
# This can be enabled for win32, when we switch to MinGW >= 4.4.x.
}
# for extra security on win32: enable ASLR and DEP via GCC linker flags
